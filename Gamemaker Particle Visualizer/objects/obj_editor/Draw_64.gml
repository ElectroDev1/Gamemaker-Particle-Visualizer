...
switch(State){
	   ...
	   #region Wait state
			 ...
			 var _STR = "Made by Electro"; var _X = room_width/2+20; var _Y = room_height-34;
			 ...
			 draw_text(room_width-8,room_height-8,"v1.0.0");
	   ...
	   #region Editing state
		   ...
		   if(part_system_exists(syst)){
			  ...
			  for(var a=0; a<8; a++){
				  ...
				  switch(a){ case 3: _sprite = spr_newsave_button; break; case 4: _sprite = spr_save_button; break;
					         case 1: _sprite=spr_new_button; break; case 2: _sprite = spr_open_button; break;
							 case 5: _sprite=spr_position_button; break; case 6: _sprite=spr_resize_button; break; 
							 case 7: _sprite=spr_copy_button; break; 
						   }
			      ...
			      if(mouse_in_rectangle(_X_+(64*(a)),_Y_,_X_+49+(64*(a)),_Y_+49)){
					 ...
					 switch(a){
						...
						case 6: Message="Reset emitter"; break;
						case 7: Message="Copy script"; break;
					 }
