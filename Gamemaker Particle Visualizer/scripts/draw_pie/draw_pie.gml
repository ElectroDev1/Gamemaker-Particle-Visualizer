...
/// @param  radius
/// @param  transparency
function draw_pie(argument0, argument1, argument2, argument3, argument4, argument5, argument6,offs=90) {
	...
	*/
	...
	if (argument2 > 0) { // no point even running if there is nothing to display (also stops /0)
	    ...
	    if (val > 1) { // HTML5 version doesnt like triangle with only 2 sides
	        ...
	        for(i=0; i<=val; i++) {
	            len = (i*sizeofsection)+offs; // the 90 here is the starting angle
